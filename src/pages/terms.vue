    ...
    <div class="flex max-w-[880px] flex-col items-center space-y-10 px-10">
      <div>
        ...
        <p class="small-gray-text pt-4">
          ...
          このウェブサイト上で提供するサービス「ReCap」（以下、「本サービス」といいます。）の利用条件を定めるものです。
      ...
      <div>
        ...
        <ol class="numbered-list space-y-2 pt-4">
          <li>
            本規約は、ユーザーと当サービスの提供者（以下、「当方」といいます。）との間の本サービスの利用に関わる一切の関係に適用されるものとします。
          </li>
          <li>
      ...
      <div>
        ...
        <ol class="numbered-list space-y-2 pt-4">
          ...
          <li>
            ...
            <ol class="numbered-list space-y-1 pt-1">
      ...
      <div>
        ...
        <ol class="numbered-list space-y-2 pt-4">
          ...
          <li>
            ユーザーID及びパスワードが第三者によって使用されたことによって生じた損害について、当方は一切の責任を負わないものとします。
          </li>
        </ol>
      </div>
      ...
      <div>
        ...
        <ol class="small-gray-text list-decimal space-y-2 pl-6 pt-2">
      ...
      <div>
        ...
        <ol class="numbered-list space-y-2 pt-4">
          <li>
            ...
            <ol class="numbered-list space-y-2 pt-1">
      ...
      <div>
        ...
        <ol class="numbered-list space-y-2 pt-4">
          <li>
            当方は、ユーザーが以下のいずれかに該当する場合には、事前の通知なく、ユーザーに対して、
      ...
      <div>
        ...
        <ol class="numbered-list space-y-2 pt-4">
          ...
          <li>
            当方は、ユーザーに生じたあらゆる損害について、一切の責任を負いません。
          </li>
          <li>
      ...
      <div>
        ...
        <p class="small-gray-text pt-4">
          当方は、ユーザーへの事前の告知なしに、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
        </p>
      </div>
      ...
      <div class="w-full">
        ...
        <ol class="numbered-list space-y-2 pt-4">
          <li>
            当方は、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。
          </li>
          <li>
            当方は、ユーザーが本規約変更後も本サービスを利用した場合、変更後の規約に同意したものとみなします。
          </li>
        </ol>
      </div>
      ...
      <div>
        ...
        <p class="small-gray-text pt-4">
          ...
          当方は、現在登録されている連絡先が有効なものとみなし、当該連絡先へ通知または連絡を行います。
          これらの通知または連絡は、発信時にユーザーへ到達したものとみなします。
        </p>
      </div>
